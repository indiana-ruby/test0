...
/***/ function(module, exports, __webpack_require__) {
	...
	var Btnbox = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { ref: 'btnbox', onClick: this.change, className: classes },
	      React.createElement(Btner, null)
	    );
	  }
	});
	...
	var Btner = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { onClick: this.change, className: ballclasses });
	  }
	});

	ReactDOM.render(React.createElement(Btnbox, null), document.getElementById('botton'));
