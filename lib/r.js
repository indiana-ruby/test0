...
/***/ function(module, exports, __webpack_require__) {
	...
	var Datamaker = React.createClass({
	  displayName: 'Datamaker',

	  render: function render() {
	    return React.createElement(Datareader, { data: this.props.data });
	  }
	});
	...
	ReactDOM.render(React.createElement(Datamaker, { data: data }), document.getElementById('dataer'));
	...
	var Test = React.createClass({
	  ...
	  lalaer: function lalaer() {
	    setInterval(function () {
	      lala = lala + 1;
	    }, 100);
	    console.log("lala=" + lala);
	  },
	  hoverist: function hoverist() {
	    alert('dom加载完成后，xxx');
	  },
	...
	ReactDOM.render(React.createElement(Test, { name: lala }), document.getElementById('example'));

	setTimeout(function () {
	  ReactDOM.render(React.createElement(Test, { name: lala }), document.getElementById('example2'));
	}, 10000);
	...
	var Btner = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var items = this.state.words.map(function (item, i) {
	      return React.createElement(
	        'div',
	        { key: item, onClick: this.dong, className: classes },
	        item
	      );
	    }.bind(this));
	    return React.createElement(
	...
	ReactDOM.render(React.createElement(Btner, { color: 'pink' }), document.getElementById('btner'));
	...
	var Biao = React.createClass({
	  ...
	  changword: function changword() {
	    this.setState({ biaoer: event.target.value });
	  },
	  render: function render() {
	    var biaoer = this.state.biaoer;
	    return React.createElement('input', { type: 'text', value: biaoer, onChange: this.changword });
	  }
	});

	ReactDOM.render(React.createElement(Biao, null), document.getElementById('biao'));
	...
	ReactDOM.render(React.createElement(CommentBox, { url: 'https://api.github.com/users/octocat/gists' }), document.getElementById('ajaxer'));
